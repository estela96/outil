    ...
    <div class="row contentAll">
      <div class="col-md-6">
        <div class="sub">
          ...
          <hr>
          <p>
          C<span class="svo">e</span><span class="lfp">s</span> m<span class="svo">o</span><span class="lfp">ts</span> l<span class="svo">à</span>
          </p>

          <p>
          N<span class="svo">e</span> m<span class="svn">en</span>t<span class="svo">e</span><span class="lfp">nt</span> p<span class="svo">a</span><span class="lfp">s</span>
          </p>

          <p>
          C’<span class="svo">e</span><span class="lfp">st</span> t<span class="svn">on</span>_<span class="svo">â</span>m<span class="lfp">e</span> qu<span class="svo">i</span> <span class="scf">ch</span><span class="svn">an</span>t<span class="lfp">e</span>
          </p>

          <p>
          T<span class="svo">a</span> m<span class="svo">é</span>l<span class="svo">o</span>d<span class="svo">ie</span> <span class="svo">à</span> t<span class="glide">oi</span>
          </p>
        ...
        <div class="sub">
          ...
          <p>[se mo la</p>
          <p>nə mɑ̃tə pa</p>
          <p>se tɔ̃nam ki ʃɑ̃t</p>
          <p>ta melɔdi a tɯa]</p>

          <audio controls >
            <source src="<?php echo base_url('assets/audio/transcription/strophe_6.mp3'); ?>" type="audio/mpeg">
        ...
        <div class="sub">
          ...
          <p>Estas palabras</p>
          <p>No mienten</p>
          <p>Es tu alma que canta/<p>
          <p>Tu propia melodía </p>
      ...
      <div class="col-md-6 subcontent">
        ...
        <div id="svn">
          <br>
          <p> <span style="cursor:pointer;" id="def_art_son_svn">ɔ̃</span>  (t<span class="svnC">on</span>)
            <audio id="myAudio">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/ton_a_me.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <p ><span style="cursor:pointer;" id="def_art_son_svn_2">ɑ̃</span>
            (m<span class="svnC">en</span>tent <a class="btn " id="a_svn_2" style="cursor:pointer;"><i class="fas fa-volume-up"></i></a>,
            ch<span class="svnC">an</span>te <a class="btn " id="a_svn_2_2" style="cursor:pointer;"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="myAudio2">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/mentent.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="myAudio2_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_6/chante.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
            ...
            <div id="sonido_svn_2">
              <p style="font-size: 0.9em;">Fonema<span class="svnC">[ɑ̃]</span> <p>
                ...
                <p style="text-align: justify; font-weight: lighter;">Vocal posterior, baja abierta, redondeada, nasal. (Abry & Veldeman-Abry, 2007, p. 28)</p>
                <p style="font-size: 0.9em;">Diagrama</p>
                <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/a_2.png'); ?>" alt="ɑ̃.png">
        ...
        <div id="svo">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_3">ə</span>
            ...
            ment<span class="svoC">e</span>nt <a class="btn " id="b_svo_3_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_svo_3">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/ne.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_svo_3">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/ə.png'); ?>" alt="ə.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_4">a</span>
            ...
            <span class="svoC">â</span>me <a class="btn " id="b_svo_4_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            t<span class="svoC">a</span> <a class="btn " id="b_svo_4_4" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            <span class="svoC">à</span> <a class="btn " id="b_svo_4_5" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            t<span class="svoC">oi</span> <a class="btn " id="b_svo_4_6" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_svo_4">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/la_.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_4_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_6/pas.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
                <audio id="son_svo_4_3">
                  ...
                  <audio id="son_svo_4_4">
                    <source src="<?php echo base_url('assets/audio/words/strophe_6/ta.mp3'); ?>" type="audio/mpeg">
                      Your browser does not support the audio element.
                    </audio>
                    <audio id="son_svo_4_5">
                      <source src="<?php echo base_url('assets/audio/words/strophe_6/a.mp3'); ?>" type="audio/mpeg">
                        Your browser does not support the audio element.
                      </audio>
                      <audio id="son_svo_4_6">
                        <source src="<?php echo base_url('assets/audio/words/strophe_6/toi.mp3'); ?>" type="audio/mpeg">
                          Your browser does not support the audio element.
                        </audio>
          ...
          <div id="sonido_svo_4">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/a.png'); ?>" alt="a.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_5">i</span>
            (qu<span class="svoC">i</span>, <a class="btn " id="b_svo_5" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            mélod<span class="svoC">i</span>e <a class="btn " id="b_svo_5_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_svo_5">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/qui.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_5_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_6/me_lodie.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
          ...
          <div id="sonido_svo_5">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/i.png'); ?>" alt="i.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_7">e</span>
            (c<span class="svoC">e</span>s <a class="btn " id="b_svo_7" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            c’<span class="svoC">e</span>st <a class="btn " id="b_svo_7_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            m<span class="svoC">é</span>lodie <a class="btn " id="b_svo_7_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_svo_7">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/ces.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_7_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_6/cest.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
          ...
          <div id="sonido_svo_7">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/e.png'); ?>" alt="e.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_8">ɔ</span> (mél<span class="svoC">o</span>die)
            <audio id="son_svo_8">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/me_lodie.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_svo_8">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/c_1.png'); ?>" alt="ɔ.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_9">o</span> (m<span class="svoC">o</span>ts)
            <audio id="son_svo_9">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/mots.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_svo_9">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/o.png'); ?>" alt="o.png">
        ...
        <div id="glide">
          <br>
          <p><span style="cursor:pointer;" id="def_art_son_glide_1">ɯ</span> (t<span class="glideC">oi</span>)
          ...
          <div id="sonido_glide_1">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/ɯ.png'); ?>" alt="ɯ.png">
        ...
        <div id="scf">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_scf_4">ʃ</span> (<span class="scfC">ch</span>ante)
            <audio id="son_scf_4">
              <source src="<?php echo base_url('assets/audio/words/strophe_6/chante.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_scf_4">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_6/ro_1.png'); ?>" alt="ʃʒ.png">
        ...
        <div id="schwa">
          <br>
          <p id="schwaM">e inestable (schwa) que no se pronuncia</p>
          <div id="schwaI">
            <p style="font-size: 0.9em;">Datos curiosos</p>
