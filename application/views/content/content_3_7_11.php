    ...
    <div class="row contentAll">
      <div class="col-md-6">
        <div class="sub">
          ...
          <hr>
          <p>
          J<span class="svo">e</span> s<span class="glide">ui</span><span class="lfp">s</span> c<span class="svo">o</span>m<span class="lfp">m</span><span class="schwa">e</span> c<span class="svo">i</span>
          </p>

          <p>
          <span class="svo">E</span><span class="lfp">t</span> ç<span class="svo">a</span> m<span class="svo">e</span> v<span class="svo">a</span>
          </p>

          <p>
          <span class="scf">V</span><span class="svo">ou</span><span class="lfp">s</span> n<span class="svo">e</span> m<span class="svo">e</span> <span class="scf">ch</span><span class="svn">an</span><span class="scf">g</span><span class="schwa">e</span>r<span class="svo">e</span><span class="lfp">z</span> p<span class="svo">a</span><span class="lfp">s</span>
          </p>

          <p>
          <span class="scf">J</span><span class="svo">e</span> s<span class="glide">ui</span>s c<span class="svo">o</span>m<span class="lfp">me</span> ç<span class="svo">a</span>
          </p>
          <p>
          <span class="svo">E</span>t c’<span class="svo">e</span><span class="lfp">st</span> t<span class="svn">an</span><span class="lfp">t</span> p<span class="svo">i</span><span class="lfp">s</span>
          </p>
          <p>
          <span class="scf">J</span><span class="svo">e</span> v<span class="svo">i</span><span class="lfp">s</span> s<span class="svn">an</span>s <span class="scf">v</span><span class="svo">i</span><span class="scf">s</span>-<span class="svo">à</span>-<span class="scf">v</span><span class="svo">i</span><span class="lfp">s</span>
          </p>
        ...
        <div class="sub">
          ...
          <p>[ʒə sɥi kɔm si</p>
          <p>e sa mə va</p>
          <p>vu nə mə ʃɑ̃ʒʁe pa</p>
          <p>ʒə sɥi kɔm sa</p>
          <p>e se tɑ̃ pi</p>
          <p>ʒə vi sɑ̃ vizavi]</p>



          <audio controls >
            <source src="<?php echo base_url('assets/audio/transcription/strophe_3_7_11.mp3'); ?>" type="audio/mpeg">
        ...
        <div class="sub">
          ...
          <hr>
          <p>Yo soy así</p>
          <p>Y me siento bien</p>
          <p>Ustedes no me cambiarán</p>
          <p>Yo soy asá</p>
          <p>Y qué lástima por ustedes</p>
          <p>Vivo sin enfrentamientos</p>
      ...
      <div class="col-md-6 subcontent">
        ...
        <div id="svn">
          ...
          <p ><span style="cursor:pointer;" id="def_art_son_svn_2">ɑ̃</span>
            (ch<span class="svnC">an</span>gerez <a class="btn " id="a_svn_2" style="cursor:pointer;"><i class="fas fa-volume-up"></i></a>,
            t<span class="svnC">an</span>t <a class="btn " id="a_svn_2_2" style="cursor:pointer;"><i class="fas fa-volume-up"></i></a>,
            s<span class="svnC">an</span>s <a class="btn " id="a_svn_2_3" style="cursor:pointer;"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="myAudio2">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/changerez.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="myAudio2_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/tant.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
                <audio id="myAudio2_3">
                  <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/sans.mp3'); ?>" type="audio/mpeg">
                    Your browser does not support the audio element.
                  </audio>
            ...
            <div id="sonido_svn_2">
              <p style="font-size: 0.9em;">Fonema<span class="svnC">[ɑ̃]</span> </p>
                ...
                <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/a_2.png'); ?>" alt="ɑ̃.png">
        ...
        <div id="svo">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_3">ə</span>
            (j<span class="svoC">e</span> <a class="btn " id="b_svo_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            m<span class="svoC">e</span> <a class="btn " id="b_svo_3_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            n<span class="svoC">e</span> <a class="btn " id="b_svo_3_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_svo_3">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/je.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_3_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/me.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
                <audio id="son_svo_3_3">
                  <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/ne.mp3'); ?>" type="audio/mpeg">
                    Your browser does not support the audio element.
                  </audio>
          ...
          <div id="sonido_svo_3">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <!--img src="<?php echo base_url('assets/img/diagramas/diagramas_3/ɑ̃.png'); ?>" alt="ɑ̃.png"-->
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_4">a</span>
            ...
            v<span class="svoC">a</span> <a class="btn " id="b_svo_4_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            p<span class="svoC">a</span>s <a class="btn " id="b_svo_4_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            <span class="svoC">à</span> <a class="btn " id="b_svo_4_4" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_svo_4">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/ca_1.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_4_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/va.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
                <audio id="son_svo_4_3">
                  <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/pas.mp3'); ?>" type="audio/mpeg">
                    Your browser does not support the audio element.
                  </audio>
                  <audio id="son_svo_4_4">
                    <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/a.mp3'); ?>" type="audio/mpeg">
                      Your browser does not support the audio element.
                    </audio>
          ...
          <div id="sonido_svo_4">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/a.png'); ?>" alt="a.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_5">i</span>
            (su<span class="svoC">i</span>s   <a class="btn " id="b_svo_5" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            c<span class="svoC">i</span>   <a class="btn " id="b_svo_5_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            p<span class="svoC">i</span>s   <a class="btn " id="b_svo_5_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            v<span class="svoC">i</span>s   <a class="btn " id="b_svo_5_4" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            v<span class="svoC">i</span>s-à-v<span class="svoC">i</span>s   <a class="btn " id="b_svo_5_5" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_svo_5">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/suis.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_5_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/ci.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
                <audio id="son_svo_5_3">
                  <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/pis.mp3'); ?>" type="audio/mpeg">
                    Your browser does not support the audio element.
                  </audio>
                  <audio id="son_svo_5_4">
                    <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/vis.mp3'); ?>" type="audio/mpeg">
                      Your browser does not support the audio element.
                    </audio>
                    <audio id="son_svo_5_5">
                      <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/vis-a-vis.mp3'); ?>" type="audio/mpeg">
                        Your browser does not support the audio element.
                      </audio>
          ...
          <div id="sonido_svo_5">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/i.png'); ?>" alt="i.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_6">u</span> (v<span class="svoC">ou</span>s <a class="btn " id="b_svo_6" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_svo_6">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/vous.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_svo_6">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/u.png'); ?>" alt="u.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_7">e</span>
            (<span class="svoC">e</span>t <a class="btn " id="b_svo_7" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            c’<span class="svoC">e</span>st <a class="btn " id="b_svo_7_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            changer<span class="svoC">e</span>z <a class="btn " id="b_svo_7_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)

            <audio id="son_svo_7">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/et.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
              <audio id="son_svo_7_2">
                <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/cest.mp3'); ?>" type="audio/mpeg">
                  Your browser does not support the audio element.
                </audio>
          ...
          <div id="sonido_svo_7">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/e.png'); ?>" alt="e.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_svo_11">ɔ</span> (c<span class="svoC">o</span>mme <a class="btn " id="b_svo_11" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_svo_11">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/comme.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_svo_11">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/c_1.png'); ?>" alt="ɔ.png">
        ...
        <div id="glide">
          <br>
          <p><span style="cursor:pointer;" id="def_art_son_glide_2">ɥ </span>(s<span class="glideC">ui</span>s <a class="btn " id="b_glide_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
          ...
          <div id="sonido_glide_2">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <!--img src="<?php echo base_url('assets/img/diagramas/diagramas_3/ɔ.png'); ?>" alt="ɔ.png"-->
        ...
        <div id="scf">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_scf_1">v</span>
            (<span class="scfC">v</span>a <a class="btn " id="b_scf_1" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            <span class="scfC">v</span>ous <a class="btn " id="b_scf_1_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            <span class="scfC">v</span>is <a class="btn " id="b_scf_1_3" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>,
            <span class="scfC">v</span>is-à-<span class="scfC">v</span>is <a class="btn " id="b_scf_1_4" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_scf_1">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/va.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
          ...
          <div id="sonido_scf_1">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/fv.png'); ?>" alt="fv.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_scf_2">ʁ</span> (change<span class="scfC">r</span>ez <a class="btn " id="b_scf_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_scf_2">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/changerez.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <p><span style="cursor:pointer;" id="def_art_son_scf_3">ʒ</span>
            ...
            chan<span class="scfC">g</span>erez <a class="btn " id="b_scf_3_2" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>
            )
            <audio id="son_scf_3">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/je.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
          ...
          <div id="sonido_scf_3">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/ro_1.png'); ?>" alt="ʃʒ.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_scf_4">ʃ</span> (<span class="scfC">ch</span>angerez <a class="btn " id="b_scf_4" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_scf_4">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/changerez.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_scf_4">
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/ʃʒ.png'); ?>" alt="ʃʒ.png">
          ...
          <p><span style="cursor:pointer;" id="def_art_son_scf_5">z</span> (vi<span class="scfC">s</span>-à-vis <a class="btn " id="b_scf_5" style="cursor: pointer"><i class="fas fa-volume-up"></i></a>)
            <audio id="son_scf_5">
              <source src="<?php echo base_url('assets/audio/words/strophe_3_7_11/vis-a-vis.mp3'); ?>" type="audio/mpeg">
                Your browser does not support the audio element.
              </audio>
          ...
          <div id="sonido_scf_5">
            <p style="font-size: 0.9em;">Fonema <span class="scfC">[z]</span> (duda)</p>
            <p style="font-size: 0.9em;">Descripción articulatoria</p>
            ...
            <p style="font-size: 0.9em;">Diagrama</p>
            <img src="<?php echo base_url('assets/img/diagramas/diagramas_3/sz.png'); ?>" alt="sz.png">
